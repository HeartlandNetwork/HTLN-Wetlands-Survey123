...
Access_data$C1 <- Access_data$D0to1 |> replace_na(-9999)
Access_data$C2 <- Access_data$D1to2_5 |> replace_na(-9999)
Access_data$C3 <- Access_data$D2_5to5 |> replace_na(-9999)
Access_data$C4 <- Access_data$D5to10 |> replace_na(-9999)
Access_data$C5 <- Access_data$D15to20 |> replace_na(-9999)
Access_data$C6 <- Access_data$D15to20 |> replace_na(-9999)
Access_data$C7 <- Access_data$D20to25 |> replace_na(-9999)
Access_data$C8 <- Access_data$D25to30 |> replace_na(-9999)
Access_data$C9 <- Access_data$D30to35 |> replace_na(-9999)
Access_data$C10 <- Access_data$D35to40 |> replace_na(-9999)
Access_data$BIG <- Access_data$Dgt40 |> repla-9999)
glimpse(Access_data)
...
Access_data <- Access_data |>
	select(EventID, LocationID, FeatureID, WoodyModule, WoodySpecies, 
	       EditDate, WoodySiteName, ShrubClump, D0to1,
	       D1to2_5, D2_5to5, D5to10, D10to15, D15to20, D20to25, D25to30, D30to35,
	       D35to40, Dgt40, Dgt40_1, Dgt40_2, Dgt40_3, Dgt40_4, Dgt40_5)
